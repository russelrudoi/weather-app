...
describe('convert timezone in UTC', () => {
    it('should convert timezone to time format correctly', () => {
        ...
        const unit = 'time';
        const expected = '18:00'; // Ожидаемое значение

        jest.spyOn(Date.prototype, 'getTime').mockReturnValue(1620658800000); // Заменяем текущую дату и время
    ...
    it('should convert timezone to date format correctly', () => {
        const timezone = 10800;
        const unit = 'date';
        const expected = 'May 1'; // Ожидаемое значение
